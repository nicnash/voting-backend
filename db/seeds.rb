...
i1 = u1.ideas.create(title: 'Pong in browser', body: 'Create pong using firebase and randomly pair \n with a new user')
i2 = u1.ideas.create(title: 'Krettz Website', body: 'Make a site for baller viewers')
i2 = u2.ideas.create(title: 'Book List', body: 'Make a site for books to read')
